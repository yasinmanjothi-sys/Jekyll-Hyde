        ...
        <footer className="w-full bg-black text-zinc-500 border-t border-zinc-900 py-12 px-6 flex flex-col items-center justify-center gap-6">
            ...
            <div className="flex gap-8">
                <a
                    ...
                    className="hover:text-jekyll-red transition-colors duration-300"
                >
            ...
            <div className="text-center flex flex-col items-center">
                ...
                <p className="font-mono text-xs uppercase tracking-widest">Nairobi, Kenya</p>
            </div>

            {/* Copyright */}
            <div className="text-[10px] font-mono opacity-40 mt-6 text-center">
                <p>© {new Date().getFullYear()} Jekyll & Hyde. All rights reserved. Drink responsibly.</p>
