    ...
    return (
        <>
            ...
            <div className="fixed top-0 left-0 right-0 h-20 z-40 flex items-center justify-end px-6 md:px-12 pointer-events-none pt-2">
                <Link
                    href="/reserve"
                    className="font-gothic text-2xl md:text-3xl text-white hover:text-jekyll-red transition-colors uppercase tracking-wider relative px-4 py-2 border border-transparent hover:border-jekyll-red/50 bg-transparent hover:bg-black/50 pointer-events-auto rounded backdrop-blur-sm"
                >
                    Reserve
                </Link>
            </div>
            ...
            <div className="fixed top-0 left-0 right-0 z-50 flex justify-center pointer-events-none">
                ...
                >
                    <Link href="/" className="pointer-events-auto block w-full h-full">
                        <Image
                            src="/LOGO-FINAL.svg"
                            alt="Jekyll & Hyde Official Logo - Cocktail Bar & Kitchen in Westlands, Nairobi"
                            fill
