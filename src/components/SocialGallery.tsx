...
export default function SocialGallery() {
    ...
    return (
        <section id="social" className="w-full bg-black py-16 border-b border-zinc-900 overflow-hidden relative group/section">
            ...
            <Link href="/gallery" className="group block relative cursor-pointer z-10">
                ...
                <div className="container mx-auto px-4 mb-8 text-center relative z-10">
                    <div>
                        <h2 className="text-3xl md:text-5xl font-gothic text-white mb-2 tracking-widest uppercase transition-colors group-hover:text-jekyll-red">
                            Social Alchemy
                        </h2>
