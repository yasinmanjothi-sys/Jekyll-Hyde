            ...
            <section className="flex-grow w-full flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 p-10 md:p-24 py-20 flex flex-col justify-center border-r border-zinc-900 bg-[url('https://www.transparenttextures.com/patterns/black-felt.png')]">
                    ...
                    <div className="max-w-xl mx-auto md:mx-0 w-full">
                        ...
                        <p className="text-zinc-400 font-mono text-sm md:text-base tracking-wider mb-12 text-center md:text-left max-w-md">
                        ...
                        <div className="flex flex-col gap-6 w-full">
                            <a
                                ...
                                className="group relative flex items-center justify-center gap-4 border border-zinc-700 bg-black/50 px-8 py-6 hover:bg-white hover:text-black hover:border-white transition-all duration-500 overflow-hidden"
                            >
                                ...
                                <Phone className="w-6 h-6 z-10 text-white group-hover:text-black transition-colors" />
