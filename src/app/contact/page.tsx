    ...
    return (
        <main className="min-h-screen bg-jekyll-black text-jekyll-parchment flex flex-col">
            ...
            <section className="flex-grow w-full flex flex-col md:flex-row">
                    ...
                    <div className="max-w-xl mx-auto md:mx-0 w-full">
                        ...
                        <div className="space-y-10 text-zinc-400 font-mono tracking-wider">
                            ...
                            <div className="flex items-start gap-6 pt-6 border-t border-white/10">
                                <MapPin className="w-6 h-6 text-jekyll-red shrink-0" />
                                <div>
                ...
                <div className="w-full md:w-1/2 min-h-[50vh] relative group overflow-hidden bg-jekyll-black">
                    <a
