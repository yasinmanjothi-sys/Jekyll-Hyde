...
export default function AboutPage() {
    return (
        <main className="min-h-screen bg-[#0a0a0a] text-zinc-200 pt-32 pb-32 px-6 md:px-12 selection:bg-burgundy/30">
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                <header className="mb-20 text-center">
                    ...
                    >
                        <h1 className="text-6xl md:text-8xl font-gothic tracking-widest text-burgundy uppercase mb-8 drop-shadow-[0_0_10px_rgba(128,0,32,0.5)]">
                            Our Story
                        </h1>
                        <div className="w-1/4 h-[1px] bg-gradient-to-r from-transparent via-burgundy to-transparent mx-auto"></div>
                    </motion.div>
                </header>
                ...
                <article className="space-y-12 font-sans font-light text-lg md:text-xl text-zinc-400 leading-relaxed">
                    ...
                    <motion.div 
                        ...
                        className="pl-6 md:pl-10 border-l-2 border-burgundy"
                    >
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-br from-burgundy/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
                    ...
                    >
                        <p className="text-2xl md:text-3xl font-gothic text-burgundy tracking-[0.2em] uppercase">
                    ...
                    >
                        ...
                        <p className="mt-4 text-xl md:text-2xl font-mono text-burgundy/80 italic">
